<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InvoiceDetails.aspx.cs" Inherits="BillingERPSelfCare.Accounts.InvoiceDetails" %>
            ...
            <div class="card-body">
                    ...
                    <MasterTableView HeaderStyle-Font-Bold="false" AutoGenerateColumns="true" HeaderStyle-Font-Size="Small">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                                <ItemTemplate>
                                    <telerik:RadButton runat="server" ID="btnDownload" ForeColor="Red" Text="DOWNLOAD" Font-Size="Small" OnClick="btnDownload_Click"></telerik:RadButton>
                                </ItemTemplate>
                ...
                <div style="float: right">
                    <div class="form-group row gutters">
                        <label for="txtamount" class="col-sm-5 col-form-label">Total Amount</label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="txtamount" Style="text-align: right" class="form-control" ReadOnly="true" runat="server" ForeColor="red" CssClass="form-control form-control-sm" Width="130px"></asp:TextBox>
