...
{
    public partial class PackageDowngrade : BasePageClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (pageLtl != null)
            {
                pageLtl.Text = "Package Downgradation Request";
            }
        }
        ...
        void InfoLoad()
        {
            try
            {
                ...
                foreach (DataRow dataRow in dt.Rows)
                {
                    ...
                    {
                        if (dataRow["BID"].ToString() == "1")
                        {
                            Message.Show("You are already in the lowest package value!");
                            txtCustomerID.Text = string.Empty;
                            return;
                        }
