<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PackageChange.aspx.cs" Inherits="BillingERPSelfCare.Sales.PackageChange" %>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <asp:RadioButtonList ID="radiType" runat="server" TextAlign="right" RepeatDirection="Horizontal" CssClass="Space" AutoPostBack="true" OnSelectedIndexChanged="radiType_SelectedIndexChanged">
                                                <asp:ListItem Text="UP-GRADATION" Value="UP-GRADATION" />

                                                <asp:ListItem Text="DOWNGRADATION" Value="DOWNGRADATION" />
                                            </asp:RadioButtonList>
