...

{
    public class SSLCommarz
    {
        ...
        public string SSLCz_URL = "https://securepay.sslcommerz.com/";
        ...
        public SSLCommarz(string Store_ID, string Store_Pass, bool Store_Test_Mode = false)
        {
        ...
        public string InitiateTransaction(NameValueCollection PostData, bool GetGateWayList = false)
        {
            ...
            try
            {
                ...
                {
                    WriteLogFile.WriteLog("Unable to get data from SSLCommerz. Please contact your manager!");
                    throw new Exception("Unable to get data from SSLCommerz. Please contact your manager!");
                }
            }
            catch (Exception e)
            {
                WriteLogFile.WriteLog(e.Message.ToString());
        ...
        protected void SetSSLCzTestMode(bool mode)
        {
            ...
            if (mode)
            {
                this.Store_ID = "amberit001live";
                this.Store_Pass = "amberit001live31461";
        ...
        protected string SendPost(NameValueCollection PostData)
        {
            ...
            string response = SSLCommarz.Post(this.SSLCz_URL + this.Submit_URL, PostData);
            return response;
        }
